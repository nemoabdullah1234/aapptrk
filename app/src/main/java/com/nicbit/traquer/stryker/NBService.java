...
import com.nicbit.traquer.common.geofence.GefenceDeviceContract;
import com.nicbit.traquer.common.geofence.GeofenceApiResponse;
import com.nicbit.traquer.common.geofence.GeofenceDevicePresenter;
import com.nicbit.traquer.common.utils.Constant;
import com.nicbit.traquer.stryker.exception.NicbitException;
import com.nicbit.traquer.stryker.splash.StrykerSplashActivity;
...
import io.akwa.trakit.rulehandler.TrackingSettingUtil;
    ...
    private final class ServiceHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
           ...
           /* Log.i("Handle Message", "Scaning Start");
            ...
            io.akwa.trakit.rulehandler.Config config = new io.akwa.trakit.rulehandler.Config(apiToken, deviceId, projectId, clientId, code, null, beaconData);
            if (ruleHandler == null) {
