...
//        apiHandler.setLoginResponseListener(this);
//        LoginRequestModel loginRequestModel = new LoginRequestModel();
//        loginRequestModel.setEmail(email);
//        loginRequestModel.setOs("android");
//        String channelId = UAirship.shared().getPushManager().getChannelId();
//        loginRequestModel.setChannelId(channelId);
//        loginRequestModel.setPassword(password);
//        loginRequestModel.setTimezone(Calendar.getInstance().getTimeZone().getID());
//        apiHandler.getLoginDataFromApi(loginRequestModel);
